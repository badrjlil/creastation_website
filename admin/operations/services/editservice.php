...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "select * from serv where serv_id=" . $id;
...
<body>
    <form action="" class="editform" method="post">
        <div class="contentedit">
            ...
            <div class="inputs">
                <input type="text" value="<?= $result['serv_title'] ?>" placeholder="Title ...">
                <select name="serv" id="">
                    <?php
                    ...
                    while ($service = mysqli_fetch_assoc($services)) {
                        ?>
                        <option value="<?= $service['cat_id'] ?>" <?php if ($result['cat_id'] == $service['cat_id']) { ?>
                                selected <?php } ?>>
                            <?= $service['cat_title'] ?>
                        </option>
                        <?php
